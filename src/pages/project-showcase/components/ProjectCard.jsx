    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex space-x-2">
          {project.liveDemo && (
            <div className="w-8 h-8 bg-surface backdrop-blur-glass rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      ...
      {/* Project Content */}
      <div className="p-6">
        <h3 className="text-xl font-heading font-bold text-white mb-2 group-hover:text-glow-primary transition-all duration-300">
          {project.title}
        </h3>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.technologies.slice(0, 3).map((tech, index) => (
            <span
              key={index}
              className="px-2 py-1 bg-surface-light text-xs font-medium text-text-muted rounded border border-border"
            >
              {tech}
            </span>
          ))}
          {project.technologies.length > 3 && (
            <span className="px-2 py-1 bg-surface-light text-xs font-medium text-text-muted rounded border border-border">
        ...
        <div className="flex items-center justify-between">
          <button className="flex items-center space-x-2 text-sm font-medium text-primary hover:text-white transition-colors duration-300">
